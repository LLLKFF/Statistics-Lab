...
- 新增 `Weekly Macro Review #001｜2026-W38` 正式周报与 12 页 Institutional Edition PDF，包含 6 张核心图表、情景地图、失效条件及下一周验证清单。
...
- 将 2026-W38 周报由工作底稿重写为 `Final / Weekly Close`：统一“央行动作—反应函数—实际利率—资产现金流”的周度叙事，并冻结 9 月 18 日纽约收盘信息边界。
- 将周报研究状态由 `Prototype` 更新为正式周结版本，证据等级维持 B；明确名义 CMT 减实际 CMT 仅为描述性近似。
